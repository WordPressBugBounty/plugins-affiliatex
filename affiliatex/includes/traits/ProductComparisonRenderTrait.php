...
trait ProductComparisonRenderTrait {
	...
	private function render_pc_stars( $rating, $starColor, $starInactiveColor ) {
		return AffiliateX_Helpers::render_stars( $rating, $starColor, $starInactiveColor, 25, array( 'wrapper_class' => 'rating-stars' ) );
	}

	protected function get_fields(): array {
		return array(
			'block_id'               => '',
			'productComparisonTable' => array(),
			'comparisonSpecs'        => array(),
			'pcRibbon'               => true,
			'pcTitle'                => true,
			'starColor'              => '#FFB800',
