...
class PlatformConfig {
	...
	public function refresh_creator_token() {
		...
		require_once AFFILIATEX_PLUGIN_DIR . '/includes/platforms/api/amazon/AmazonCreatorApi.php';
		$token_url = \AffiliateX\Platforms\Api\Amazon\AmazonCreatorApi::get_token_endpoint( $this->creator_version );
