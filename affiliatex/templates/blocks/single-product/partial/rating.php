<?php defined( 'ABSPATH' ) || exit; if ( $edRatings && $PricingType === 'picture' ) : ?>
	<div class="affx-sp-pricing-pic rating-align-<?php echo esc_attr( $productStarRatingAlign ); ?> <?php echo esc_attr( $ratingHideClass ?? '' ); ?>">
...
<?php elseif ( $edRatings && $PricingType === 'number' ) : ?>
	<div class="affx-rating-box affx-rating-number <?php echo esc_attr( $ratingHideClass ?? '' ); ?>">
