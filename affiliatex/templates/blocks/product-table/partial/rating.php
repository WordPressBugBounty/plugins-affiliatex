<?php if ( $edRating && ! empty( $product['rating'] ) ) : ?>
	...
	<?php elseif ( $layoutStyle === 'layoutThree' ) : ?>
		<?php echo \AffiliateX\Helpers\AffiliateX_Helpers::kses( $this->render_pt_stars( $product['rating'], $starColor, $starInactiveColor ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	<?php endif; ?>
<?php endif; ?>
